...
public class TotpConfig {
    ...
    /**
     * Returns the number of scratch codes to generate. We are using Google's
     * default of providing 5 scratch codes.
     *
    ...
    /**
     * Returns the cryptographic hash function used to calculate the HMAC
     * (Hash-based
    ...
    public static class TotpConfigBuilder {
        ...
        public TotpConfigBuilder setNumberOfScratchCodes(int numberOfScratchCodes) {
        ...
        public TotpConfigBuilder setSecretBits(int secretBits) {
            if (secretBits < 128) {
